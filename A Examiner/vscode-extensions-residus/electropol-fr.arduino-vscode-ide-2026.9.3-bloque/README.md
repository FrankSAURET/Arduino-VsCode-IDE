# Arduino VsCode IDE
![alt text](https://github.com/FrankSAURET/Arduino-VsCode-IDE/raw/HEAD/images/LogoVsCodeArduinoIDE.png)
...
>
> Original extension © Microsoft Corporation — licensed under the [MIT License](https://github.com/FrankSAURET/Arduino-VsCode-IDE/blob/HEAD/LICENSE.txt).
...
![alt text](https://github.com/FrankSAURET/Arduino-VsCode-IDE/raw/HEAD/images/Doc-Page%201.png)
...
> **Note**: Arduino CLI is licensed under the [GPL-3.0 license](https://github.com/arduino/arduino-cli/blob/master/LICENSE.txt) by Arduino SA. See [NOTICE-ARDUINO-CLI.md](https://github.com/FrankSAURET/Arduino-VsCode-IDE/blob/HEAD/NOTICE-ARDUINO-CLI.md) for details.

### C/C++ extension (optional)
IntelliSense (completion, navigation, error checking) is provided by the [C/C++ extension](https://marketplace.visualstudio.com/items?itemName=ms-vscode.cpptools), which reads the `.vscode/c_cpp_properties.json` file generated by this extension. It is only a recommendation: verifying, uploading, the serial monitor, the board and library managers all work without it.

On editors that do not ship the Microsoft Marketplace (VSCodium, Gitpod, …) the C/C++ extension is not available; [clangd](https://open-vsx.org/extension/llvm-vs-code-extensions/vscode-clangd) can be used instead.
...
See [CONTRIBUTING.md](https://github.com/FrankSAURET/Arduino-VsCode-IDE/blob/HEAD/CONTRIBUTING.md) for development setup details.
...
Licensed under the [MIT License](https://github.com/FrankSAURET/Arduino-VsCode-IDE/blob/HEAD/LICENSE.txt). See the [Third Party Notices](https://github.com/FrankSAURET/Arduino-VsCode-IDE/blob/HEAD/ThirdPartyNotices.txt) file for additional copyright notices and terms.
